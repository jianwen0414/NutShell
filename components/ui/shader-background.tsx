...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    function render(now: number) {
      raf = 0
      // `canvas` and `gl` are already non-null by the early returns above, but
      // this is a hoisted declaration so the compiler cannot carry that
      // narrowing in. The two extra checks are the whole diff from upstream.
